 ...
 */
public class CircleImageInUsercBehavior extends CoordinatorLayout.Behavior<RoundedImageView> {
     ...
     * @param dependency
     */
    private void init(CoordinatorLayout parent, RoundedImageView child, View dependency) {
        if (mStartAvatarY == 0) {
